...
Canonical active runtime names are OpenCode, Codex CLI, Cursor IDE, and Copilot CLI. `cursor-agent` is an inactive Cursor alias. Claude Code is a retired migration and consent-gated historical-import source, not an active runtime.
