...
- Fixed slow schema, report and check explanations and recovery guidance by reusing immutable parsed contracts, while reading current authority bytes and validating each invocation.
