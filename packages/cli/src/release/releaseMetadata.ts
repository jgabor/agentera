 ...
 *
 * Plus an advisory check on a present `bundle/.agentera-npx-bundle.json`
 * sentinel. Bundle construction is governed by
 * `docs/packaging/v3-packaging.md`: checkout `prepack` rejects direct packing,
 * while `pack:dry-run` constructs an isolated package with lifecycle scripts
 * disabled. A missing checkout bundle is therefore not a release blocker.
 *
