...
export function personalGlossaryReviewRecordsContract(pathname: string = glossaryEntryAuthorityPath()): PersonalGlossaryReviewRecordsContract {
  ...
  return {
    ...
    recordMaxSerializedUtf8Bytes: typeof persistence?.record_max_serialized_utf8_bytes === "number" ? persistence.record_max_serialized_utf8_bytes : 0,
    storeMaxSerializedUtf8Bytes: typeof persistence?.max_serialized_utf8_bytes === "number" ? persistence.max_serialized_utf8_bytes : 0,
    ...
    exactMaxSerializedUtf8Bytes: typeof exact?.max_serialized_utf8_bytes === "number" ? exact.max_serialized_utf8_bytes : 0,
    terminalMetadataDays: typeof maintenance?.terminal_metadata_days === "number" ? maintenance.terminal_metadata_days : 0,
