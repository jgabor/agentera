  ...
  return [
    ...
    "current private projection, current evidence, and quality gate, then emits automatic_admission, review_required, or abstain.",
     "It never writes a review, profile, project glossary, candidate projection, or project state. Host confidence cannot enable",
      ...
      "Personal glossary publication consumes only a current CLI automatic admission with explicit_current_authorized reason.",
      ...
      "reads a project glossary, or echoes candidate content. Review-required publication needs separately owned current-user proof and",
      "is not implemented by this command.",
