...
export function readArgvFlag(argv: readonly string[], index: number, name: string): string | null {
  const a = argv[index];
 ...
 */
export function makeArgvValueReader(argv: readonly string[], getIndex: () => number, setIndex: (index: number) => void): (name: string) => string | null {
