...
export function slimOrchestrationContext(value: Dict): Dict {
...
export function slimEvidenceContext(value: Dict): Dict {
  const compact: Dict = { ...value };
...
export function slimCloseoutContext(value: Dict): Dict {
  const compact: Dict = { ...value };
