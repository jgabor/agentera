...
export function closeoutReleaseBoundary(changelogBoundary: JsonObject, bundle: JsonObject): JsonObject {
  ...
  return {
    ...
    publication_evidence: {
      ...
      source_provenance: sourceProvenance("closeout_context", preCutoverCommand("prime --context document"), "release_boundary.publication_evidence"),
    ...
    app_refresh_evidence: {
      ...
      source_provenance: sourceProvenance("status", preCutoverCommand("prime"), "app.status"),
    },
    caveats,
  };
}
