...
import { allocateEntityId, canonicalEntityRecordViolations, publishEntityUnderLock, replaceEntityUnderLock, validateEntityState, withEntityWriterLock, type DiscoveredEntity } from "./entityStorage.js";
...
function relevant(root: string, sourceRoot: string): DiscoveredEntity[] {
  const discovery = validateEntityState(root, sourceRoot);
