...
const sharedFixture = inject("packageFixture");
const isolatedConstructionRoot = path.join(sharedFixture.root, "source parity construction");
const isolatedPackageRoot = path.join(sharedFixture.root, "source parity package");
fs.cpSync(sharedFixture.constructionRoot, isolatedConstructionRoot, { recursive: true });
fs.cpSync(sharedFixture.packageRoot, isolatedPackageRoot, { recursive: true });
const fixture = {
  ...sharedFixture,
  constructionRoot: isolatedConstructionRoot,
...
describe("source and extracted-package semantic parity", { timeout: 120_000 }, () => {
