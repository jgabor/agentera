...
if (!buildRoot || !project || !ready || !start || !result || !what) throw new Error("progress race input is incomplete");
...
let stdout = "";
let stderr = "";
const code = main(["node", "agentera", "state", "progress", "append", "--project", project, "--input", "-", "--format", "json"], {
  out: (text) => {
    stdout += text;
  },
  err: (text) => {
