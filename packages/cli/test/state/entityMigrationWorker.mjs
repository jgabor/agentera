...
if (process.env.AGENTERA_ENTITY_MIGRATION_WORKER_OPERATION === "rollback") {
  ...
  applyEntityMigration(process.env.AGENTERA_ENTITY_MIGRATION_CRASH_PROJECT, process.env.AGENTERA_ENTITY_MIGRATION_CRASH_SOURCE_ROOT, process.env.AGENTERA_ENTITY_MIGRATION_CRASH_FINGERPRINT, process.env.AGENTERA_ENTITY_MIGRATION_CRASH_DIGEST, process.env.AGENTERA_ENTITY_MIGRATION_APPROVAL_FILE);
}
