...
- [x] [chore] Merge repository into jgabor/agentera as packages/mobile (@agentera/mobile) · docs stub landed 2026-06-05
- [x] [chore] Wire lefthook pre-commit for packages/mobile · `.lefthook.yml` mobile hook added 2026-06-05
