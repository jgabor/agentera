...
is the sole source/package/build execution origin beside isolated stress and
typecheck owners; machine-sensitive performance runs alone after that batch
settles, then compact and capability-contract read the lease-free generation.
