...
ALLOWED_USES = (
    ...
    AllowedUse(
        ...
        r"Decision 44|Git-only checkpoint language|checkpoint wording is limited to Git commit contexts|test_bundle_freshness\.py|Vocabulary drift",
        "The active plan quotes the Decision 44 task scope and acceptance criteria for removing or bounding these terms; test file name references such as test_bundle_freshness.py and plan 'why' descriptions of drift are not Agentera preferred vocabulary.",
    ),
    AllowedUse(
