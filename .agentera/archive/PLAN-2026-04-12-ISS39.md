# Plan: Optimera Multi-Objective Support (ISS-39, Decision 31)
...
Today optimera pins a single OBJECTIVE.md / EXPERIMENTS.md / .optimera/harness, requiring hand-written archive moves to rotate targets. .optimera/ lives outside .agentera/, splitting artifact roots. Decision 31 (firm) prescribes named subdirs, self-contained per objective, with active-objective inference. This unblocks concurrent and sequential optimization work on different skills.

## Constraints

- Decision 31 is firm: named subdirs, self-contained, infer active, drop from DOCS.md
