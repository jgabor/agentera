...
deadline. Overlap stops starting work 10,000 ms before the 1,800,000 ms envelope,
...
child execution plus the 4,000 ms reconciliation reserve remain. The 1,800,000 ms
source envelope retains headroom over the observed 1,190,728 ms cold private
